...
(define (cadr s) (car (cdr s))) ; the second element of s
(define (caddr s) (cadr (cdr s))) ; the third element of s
...
(define (make-exp base exponent)
  (cond ((= exponent 0) 1) ; exponent is a non-negative integer, so not use =number?
        ((= exponent 1) base)
