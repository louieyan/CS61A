...
def best_predictor(user, restaurants, feature_fns):
    ...
    # BEGIN Question 8
    d = {find_predictor(user, reviewed, fn)[0]: find_predictor(user, reviewed, fn)[1]
...
def rate_all(user, restaurants, feature_fns):
    ...
    reviewed = user_reviewed_restaurants(user, restaurants)
    # BEGIN Question 9
    return {restaurant_name(r): user_rating(user, restaurant_name(r)) if r in reviewed else predictor(r) 
