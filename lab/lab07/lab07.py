...
def cumulative_sum(t):
    ...
    if t.is_leaf():
        ...
        for b in t.branches: # wrong if you write: t.label + sum([cumulative_sum(b).label for b in t.branches])
            cumulative_sum(b) # might because the expr in list comprehension changes the list it iterate through
